...
export function LandmanDashboard() {
    ...
    <div className="space-y-8 max-w-5xl mx-auto mt-8 animate-fade-in">
      <div className="space-y-2">
        <h1 className="text-4xl font-light text-slate-100 tracking-tight">
          Good Morning, <span className="font-semibold text-white">Landman</span>.
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-slate-900 border border-slate-800 p-4 rounded-xl">
          <p className="text-xs text-slate-400 font-bold uppercase mb-1">Open Title Gaps</p>
          <p className="text-2xl font-bold text-rose-400">12</p>
        </div>
        <div className="bg-slate-900 border border-slate-800 p-4 rounded-xl">
          <p className="text-xs text-slate-400 font-bold uppercase mb-1">Pending Leases</p>
          <p className="text-2xl font-bold text-amber-400">8</p>
        </div>
        <div className="bg-slate-900 border border-slate-800 p-4 rounded-xl">
          <p className="text-xs text-slate-400 font-bold uppercase mb-1">Curative Items</p>
          <p className="text-2xl font-bold text-indigo-400">5</p>
        </div>
        <div className="bg-slate-900 border border-slate-800 p-4 rounded-xl">
          <p className="text-xs text-slate-400 font-bold uppercase mb-1">Total NMA</p>
          <p className="text-2xl font-bold text-emerald-400">4,250</p>
        </div>
      </div>
      ...
      <div className="bg-slate-900/60 backdrop-blur-xl border border-slate-800 rounded-3xl p-8 space-y-6 shadow-2xl">
        <h2 className="text-xl font-medium text-slate-200 border-b border-slate-800/80 pb-4 flex items-center gap-2">
          <ShieldCheck className="w-5 h-5 text-amber-500" /> Title & Acquisition Alerts
        </h2>
        
        <ul className="space-y-5">
          <li className="flex items-center gap-4 text-slate-300">
            <div className="w-2.5 h-2.5 rounded-full bg-rose-500 shadow-[0_0_10px_rgba(244,63,94,0.5)]" />
            <button onClick={() => push({ id: "tract-88", type: "PROPERTY", label: "Title Issue" })} className="hover:text-white transition-colors text-left text-lg group flex items-center gap-2">
              <span><strong className="text-white font-medium">1 tract</strong> has an unresolved break in chain of title (1985).</span>
          ...
          <li className="flex items-center gap-4 text-slate-300">
            ...
            <span className="text-lg"><strong className="text-white font-medium">3 leases</strong> are approaching their Pugh clause expiration date.</span>
          </li>
        </ul>
      </div>
    </div>
