...
for fp in files:
    try:
        ...
        c = c.replace('import { submitGenericForm } from \'@/actions/genericActions\';\\nimport React', 'import { submitGenericForm } from \'@/actions/genericActions\';\nimport React')
        c = c.replace('onSubmit={handleSubmit}}', 'onSubmit={handleSubmit}')
